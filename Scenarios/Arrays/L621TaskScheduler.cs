...
namespace Scenarios.Arrays
{
    ...
    class L621TaskScheduler
    {
        public void Test()
        {
            Console.WriteLine(this.LeastInterval(new char[] { 'A', 'A', 'A', 'B', 'B', 'B' }, 2));
            Console.WriteLine(this.LeastInterval1(new char[] { 'A', 'A', 'A', 'B', 'B', 'B' }, 2));

            Console.WriteLine(this.LeastInterval(new char[] { 'A', 'A', 'A', 'B', 'B', 'B', 'C', 'C', 'C', 'C' }, 2));
            Console.WriteLine(this.LeastInterval1(new char[] { 'A', 'A', 'A', 'B', 'B', 'B', 'C', 'C', 'C', 'C' }, 2));

            Console.WriteLine(this.LeastInterval1(new char[] { 'A', 'A', 'A', 'B', 'B', 'B', 'C', 'C' }, 1));
            Console.WriteLine(this.LeastInterval1(new char[] { 'A', 'A', 'A', 'B', 'B', 'B', 'C', 'C' }, 1));

            Console.WriteLine(this.LeastInterval1(new char[] {'G','C','A','H','A','G','G','F','G','J','H','C','A','G','E','A','H','E','F','D','B',
                'D','H','H','E','G','F','B','C','G','F','H','J','F','A','C','G','D','I','J','A','G','D','F','B','F','H','I','G','J','G','H','F',
                'E','H','J','C','E','H','F','C','E','F','H','H','I','G','A','G','D','C','B','I','D','B','C','J','I','B','G','C','H','D','I',
                'A','B','A','J','C','E','B','F','B','J','J','D','D','H','I','I','B','A','E','H','J','J','A','J','E','H','G','B','F','C','H','C','B',
                'J','B','A','H','B','D','I','F','A','E','J','H','C','E','G','F','G','B','G','C','G','A','H','E','F','H','F','C','G','B','I','E','B','J',
                'D','B','B','G','C','A','J','B','J','J','F','J','C','A','G','J','E','G','J','C','D','D','A','I','A','J','F','H','J','D','D','D','C','E','D',
                'D','F','B','A','J','D','I','H','B','A','F','E','B','J','A','H','D','E','I','B','H','C','C','C','G','C','B','E','A','G','H','H','A','I','A',
                'B','A','D','A','I','E','C','C','D','A','B','H','D','E','C','A','H','B','I','A','B','E','H','C','B','A','D','H','E','J','B','J','A','B','G','J',
                'J','F','F','H','I','A','H','F','C','H','D','H','C','C','E','I','G','J','H','D','E','I','J','C','C','H','J','C','G','I','E','D','E','H','J','A',
                'H','D','A','B','F','I','F','J','J','H','D','I','C','G','J','C','C','D','B','E','B','E','B','G','B','A','C','F','E','H','B','D','C','H','F','A',
                'I','A','E','J','F','A','E','B','I','G','H','D','B','F','D','B','I','B','E','D','I','D','F','A','E','H','B','I','G','F','D','E','B','E','C','C',
                'C','J','J','C','H','I','B','H','F','H','F','D','J','D','D','H','H','C','D','A','J','D','F','D','G','B','I','F','J','J','C','C','I','F','G','F',
                'C','E','G','E','F','D','A','I','I','H','G','H','H','A','J','D','J','G','F','G','E','E','A','H','B','G','A','J','J','E','I','H','A','G','E','C',
        ...
        public int LeastInterval(char[] tasks, int n)
        {
            ...
            for (var i = 0; i < tasks.Length; i++)
            {
                if (arr[tasks[i] - 'A'] == 0) distinct++;
                arr[tasks[i] - 'A']++;
            }
            int duration = tasks.Length;
            ...
            while (count < tasks.Length)
            {
                for (var i = 0; i < arr.Length; i++)
                {
                    if (arr[i] > 0)
                    {
                        ...
                        {
                            int t = n;
                            for (var j = i; j < arr.Length && t >= 0; j++)
                            {
                                if (arr[j] > 0)
                                {
                                    arr[j]--;
                        ...
                        {
                            count += distinct;
                            if (count == tasks.Length) return duration;

                            duration += (n - distinct + 1);
